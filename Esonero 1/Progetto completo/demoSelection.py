...
def test1():
    ...
    minLen = 10
    start = time()
    res = sampleMedianSelect.sampleMedianSelect(l, position, minLen)
    elapsed = time() - start
    print("sampleMedianSelect (with minLen={}) takes {} seconds. Selected element in position {} is {}".format(minLen,
                                                                                                           elapsed,
                                                                                                           position,
                                                                                                           res))

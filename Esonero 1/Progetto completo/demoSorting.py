...
if __name__ == "__main__":
    ...
    print('')
    runningTime = sortingTest(inputList, nuovoQuicksort.newQuickSort, 0)
    print("newQuickSort(Rec) with sampleMedianSelect required {} seconds.".format(runningTime))
    runningTime = sortingTest(inputList, nuovoQuicksort.newQuickSort, 1)
    print("newQuickSort(Rec) with selectRand required {} seconds.".format(runningTime))
    runningTime = sortingTest(inputList, nuovoQuicksort.newQuickSort, 2)
    print("newQuickSort(Rec) with selectDet required {} seconds.".format(runningTime))
    runningTime = sortingTest(inputList, nuovoQuicksort.newQuickSortIter, 0)
    print("newQuickSortIter with sampleMedianSelect required {} seconds.".format(runningTime))
    runningTime = sortingTest(inputList, nuovoQuicksort.newQuickSortIter, 1)
    print("newQuickSortIter with selectRand required {} seconds.".format(runningTime))
    runningTime = sortingTest(inputList, nuovoQuicksort.newQuickSortIter, 2)
    print("newQuickSortIter with selectDet required {} seconds.".format(runningTime))
    print('')
    ...
    runningTime = sortingTest(inputList, Sorting.pythonSort)
    print("Python's sort method required {}".format(runningTime))

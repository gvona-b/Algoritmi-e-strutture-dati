...
if __name__ == "__main__":
    ...
    print("newQuickSort with sampleMedianSelect required {} seconds.".format(runningTime))
    runningTime = sortingTest(inputList, nuovoQuicksort.newQuickSort, 1)
    print("newQuickSort with Rand required {} seconds.".format(runningTime))
    runningTime = sortingTest(inputList, nuovoQuicksort.newQuickSort, 2)
    print("newQuickSort with det required {} seconds.".format(runningTime))
    ...
    print("newQuickSortIter with Rand required {} seconds.".format(runningTime))
    runningTime = sortingTest(inputList, nuovoQuicksort.newQuickSortIter, 2)
    print("newQuickSortIter with det required {} seconds.".format(runningTime))
    print('')
